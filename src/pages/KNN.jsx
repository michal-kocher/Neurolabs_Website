        ...
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-8 lg:gap-12 items-center w-full">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 lg:gap-4">
              <Link to="/regression" className="px-8 lg:px-12 py-4 lg:py-5 bg-[#8E05C2] rounded-full font-black hover:bg-[#700B97] transition-all flex items-center gap-3 uppercase text-xs tracking-widest shadow-[0_0_40px_rgba(142,5,194,0.3)] group">
                Regresja <ChevronRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </Link>
