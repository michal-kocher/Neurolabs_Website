        ...
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-8 lg:gap-12 items-center w-full">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-xl leading-relaxed mb-8 lg:mb-12 border-l-2 border-[#8E05C2] pl-6 lg:pl-8">
              Specjalizuję się w wizualizacji procesów decyzyjnych AI. Wykorzystując algorytm <strong>K-Najbliższych Sąsiadów</strong>, badam jak dane grupują się w przestrzeni euklidesowej. Kliknij na mapie, aby wysłać sondę i sprawdzić lokalną gęstość klastrów.
            </p>
