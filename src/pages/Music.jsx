    ...
    <div className="relative bg-[#000000] text-white font-sans selection:bg-[#8E05C2]/30 min-h-screen overflow-x-hidden">
      ...
      <section className="relative pt-20 pb-4 px-4 sm:px-8 z-10 max-w-7xl mx-auto h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden">
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-6 lg:gap-8 items-stretch w-full h-full">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 text-[9px] font-bold tracking-widest uppercase mb-4">
            ...
            <div className="flex flex-wrap gap-2 lg:gap-3">
              <Link to="/pong" className="px-6 lg:px-8 py-3 lg:py-4 bg-[#8E05C2] rounded-full font-black hover:bg-[#700B97] transition-all flex items-center gap-2 uppercase text-xs tracking-widest shadow-[0_0_40px_rgba(142,5,194,0.3)] group">
                Q-Learning <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
