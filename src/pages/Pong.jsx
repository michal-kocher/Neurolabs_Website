        ...
        <div className="grid lg:grid-cols-[1.2fr,1fr] gap-6 lg:gap-8 items-stretch w-full h-full">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2 lg:gap-3">
              <Link to="/agent" className="px-6 lg:px-8 py-3 lg:py-4 bg-[#8E05C2] rounded-full font-black hover:bg-[#700B97] transition-all flex items-center gap-2 uppercase text-xs tracking-widest shadow-[0_0_40px_rgba(142,5,194,0.3)] group">
                Agent AI <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
              </Link>
